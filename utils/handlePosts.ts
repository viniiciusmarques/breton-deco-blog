 ...
 */
export const filterPostsByTerm = (posts: BlogPost[], _term: string) =>
  posts.filter(({ sections, excerpt, title }) =>
    [sections, excerpt, title].some((_field) => {
      // AJUSTAR
 ...
 * @param slug Category Slug to be filter
 */
export const filterRelatedPosts = (posts: BlogPost[], slug: string[]) =>
